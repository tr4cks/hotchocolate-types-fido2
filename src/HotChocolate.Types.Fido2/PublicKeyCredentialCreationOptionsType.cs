...
{
    protected override void Configure(
        IObjectTypeDescriptor<PublicKeyCredentialRpEntity> descriptor)
    {
        descriptor.BindFieldsExplicitly()
        ...
        descriptor.Field(f => f.Id)
            .Type<StringType>()
            .Description(ObjectTypeResources
                .PublicKeyCredentialRpEntityType_Id_Description);

        descriptor.Field(f => f.Name)
            .Type<NonNullType<StringType>>()
            .Description(ObjectTypeResources
                .PublicKeyCredentialRpEntityType_Name_Description);
    }
}
...
public class PublicKeyCredentialParametersType : ObjectType<PubKeyCredParam>
{
    protected override void Configure(IObjectTypeDescriptor<PubKeyCredParam> descriptor)
    {
        descriptor.BindFieldsExplicitly()
            ...
            .Description(
                ObjectTypeResources.PublicKeyCredentialParametersType_Description);

        descriptor.Field(f => f.Type)
            .Type<NonNullType<EnumMemberType<PublicKeyCredentialType>>>()
            .Description(ObjectTypeResources
                .PublicKeyCredentialParametersType_Type_Description);

        descriptor.Field(f => f.Alg)
            .Type<NonNullType<LongType>>()
            .Resolve(context => (long) context.Parent<PubKeyCredParam>().Alg)
            .Description(ObjectTypeResources
                .PublicKeyCredentialParametersType_Alg_Description);
    }
}
...
{
    protected override void Configure(
        IObjectTypeDescriptor<AuthenticatorSelection> descriptor)
    {
        descriptor.BindFieldsExplicitly()
            .Name(WellKnownObjectTypes.AuthenticatorSelectionCriteria)
            .Description(ObjectTypeResources
                .AuthenticatorSelectionCriteriaType_Description);

        descriptor.Field(f => f.AuthenticatorAttachment)
            .Type<EnumMemberType<AuthenticatorAttachment>>()
            .Description(ObjectTypeResources
                .AuthenticatorSelectionCriteriaType_AuthenticatorAttachment_Description);
        ...
        descriptor.Field(f => f.RequireResidentKey)
            .Type<BooleanType>()
            .Description(ObjectTypeResources
                .AuthenticatorSelectionCriteriaType_RequireResidentKey_Description);

        descriptor.Field(f => f.UserVerification)
            .Type<EnumMemberType<UserVerificationRequirement>>()
            .Description(ObjectTypeResources
                .AuthenticatorSelectionCriteriaType_UserVerification_Description);
    }
}
