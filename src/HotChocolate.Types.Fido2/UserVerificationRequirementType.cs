...
public class UserVerificationRequirementType : EnumType<UserVerificationRequirement>
{
    protected override void Configure(
        IEnumTypeDescriptor<UserVerificationRequirement> descriptor)
    {
        ...
        descriptor.Value(UserVerificationRequirement.Required)
            .Description(ObjectTypeResources
                .UserVerificationRequirementType_Required_Description);

        descriptor.Value(UserVerificationRequirement.Preferred)
            .Description(ObjectTypeResources
                .UserVerificationRequirementType_Preferred_Description);

        descriptor.Value(UserVerificationRequirement.Discouraged)
            .Description(ObjectTypeResources
                .UserVerificationRequirementType_Discouraged_Description);
    }
}
