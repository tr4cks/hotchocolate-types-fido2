...
{
    protected override void Configure(IEnumTypeDescriptor<AuthenticatorAttachment> descriptor)
    {
        ...
        descriptor.Value(AuthenticatorAttachment.Platform)
            .Description(ObjectTypeResources.AuthenticatorAttachmentType_Platform_Description);

        descriptor.Value(AuthenticatorAttachment.CrossPlatform)
            .Description(ObjectTypeResources.AuthenticatorAttachmentType_CrossPlatform_Description);
    }
}
